...
function Login() {
  ...
  const redirectUrl = () => {
    if (localStorage.getItem("userTypes") === "CUSTOMER") navigate(-1);
  ...
  const updateSignupData = (e) => {
    ...
    else if (e.target.id === "userId") setUserId(e.target.value);
    else if (e.target.id === "password") setUserPassword(e.target.value);
    else if (e.target.id === "email") setUserEmail(e.target.value);
          ...
          <div className="row m-2 ">
            <div>
              ...
              <form onSubmit={showSignup ? signupFn : loginFn}>
                ...
                <div
                  className="signup-btn text-center pe"
